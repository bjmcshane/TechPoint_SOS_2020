...
! function(t) {
    ...
    i.resize = E(u, k), i.scroll = E(u, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), i.redraw = E(), i.location = function(t) {
        ...
        t = t || {}, p = !0, u.triggerHandler("__wf_destroy"), null != t.domready && (d = t.domready), f.each(r, m), i.resize.off(), i.scroll.off(), i.redraw.off(), o = [], a = [], "pending" === _.state() && R()
    ...
    window.tram = function(t) {
        ...
        if (S.transition) {
            var I = S.timing.dom;
            if (T.style[I] = f["ease-in-back"][0], !T.style[I])
        ...
        var M = e.frame = function() {
            ...
            j = l(function(e) {
                ...
                function d(t, e, i) {
                    var o, a, s, u, c = e !== p,
                        l = {};
                    for (o in t) s = t[o], o in K ? (l.transform || (l.transform = {}), l.transform[o] = s) : (g.test(o) && (o = n(o)), o in Y ? l[o] = s : (u || (u = {}), u[o] = s));
                    for (o in l) {
                ...
                e.init = function(e) {
                    ...
                    S.backface && U.hideBackface && G(this.el, S.backface.css, "hidden")
            ...
            F = l(q, function(t, e) {
                ...
                t.init = function() {
                    e.init.apply(this, arguments), this.current || (this.current = {}, K.perspective && U.perspective && (this.current.perspective = U.perspective, G(this.el, this.name, this.style(this.current)), this.redraw()))
                }, t.set = function(t) {
        ...
        S.transform && (Y.transform = [F], K = {
            ...
            skewX: [_],
            skewY: [_]
        }), S.transform && S.backface && (K.z = [x, "translateZ"], K.rotateZ = [_], K.scaleZ = [w], K.perspective = [y]);
        var Q = /ms/,
            V = /s|\./;
        return t.tram = e
    }(window.jQuery)
    ...
    i.define("navbar", t.exports = function(t, e) {
        ...
        function R(n, i) {
            ...
            a || (a = t.data(i, m, {
                ...
                e.outside && h.off("click" + m, e.outside);
                return function(n) {
                    var i = t(n.target);
            ...
            c && "/" === c.attr("href") && null == c.attr("aria-label") && c.attr("aria-label", "home"), a.button.attr("style", "-webkit-user-select: text;"), null == a.button.attr("aria-label") && a.button.attr("aria-label", "menu"), a.button.attr("role", "button"), a.button.attr("tabindex", "0"), a.button.attr("aria-controls", a.overlayContainerId), a.button.attr("aria-haspopup", "menu"), a.button.attr("aria-expanded", "false"), a.el.off(m), a.button.off(m), a.menu.off(m), C(a), s ? (A(a), a.el.on("setting" + m, function(t) {
                return function(n, i) {
                    i = i || {};
                    var r = f.width();
                    C(t), !0 === i.open && $(t, !0), !1 === i.open && F(t, !0), t.open && e.defer(function() {
                        r !== f.width() && S(t)
                    })
                }
            }(a))) : (! function(e) {
                ...
                return function(e) {
                    switch (e.keyCode) {
                        ...
                        case o.HOME:
                        case o.END:
                            return t.open ? (e.keyCode === o.END ? t.selectedIdx = t.links.length - 1 : t.selectedIdx = 0, z(t), e.preventDefault(), e.stopPropagation()) : (e.preventDefault(), e.stopPropagation())
                    }
                }
                ...
                return function(e) {
                    if (t.open) switch (t.selectedIdx = t.links.index(document.activeElement), e.keyCode) {
                        case o.HOME:
                        case o.END:
                            return e.keyCode === o.END ? t.selectedIdx = t.links.length - 1 : t.selectedIdx = 0, z(t), e.preventDefault(), e.stopPropagation();
                        case o.ESCAPE:
                            return F(t), t.button.focus(), e.preventDefault(), e.stopPropagation();
                        case o.ARROW_LEFT:
                        case o.ARROW_UP:
                            return t.selectedIdx = Math.max(-1, t.selectedIdx - 1), z(t), e.preventDefault(), e.stopPropagation();
                        case o.ARROW_RIGHT:
                        case o.ARROW_DOWN:
                            return t.selectedIdx = Math.min(t.links.length - 1, t.selectedIdx + 1), z(t), e.preventDefault(), e.stopPropagation()
                    }
                }
            }(a))), P(n, i)
        }
        ...
        c.ready = c.design = c.preview = function() {
            if (s = p && i.env("design"), u = i.env("editor"), n = t(document.body), !(a = h.find(m)).length) return;
            a.each(R), E(), i.resize.on(O)
        }, c.destroy = function() {
            k = t(), E(), a && a.length && a.each(T)
        };
        ...
        function $(t, e) {
            if (!t.open) {
                ...
                var r = N(t),
                    ...
                    u = t.el.height(),
                    c = t.el[0];
                if (P(0, c), _.intro(0, c), i.redraw.up(), s || h.on("click" + m, t.outside), e) p();
                else {
                    var f = "transform " + n.duration + "ms " + n.easing;
                    if (t.overlay && (k = t.menu.prev(), t.overlay.show().append(t.menu)), n.animOver) return l(t.menu).add(f).set({
                        x: n.animDirect * a,
                        height: r
                    }).start({
                        x: 0
        ...
        function F(t, e) {
            if (t.open) {
                ...
                var n = t.config;
                if (("none" === n.animation || !l.support.transform || n.duration <= 0) && (e = !0), _.outro(0, t.el[0]), h.off("click" + m, t.outside), e) return l(t.menu).stop(), void u();
            ...
            function u() {
                t.menu.height(""), l(t.menu).set({
                    x: 0,
                    y: 0
                }), t.menu.each(q), t.links.removeClass(x), t.dropdowns.removeClass(w), t.dropdownToggle.removeClass(b), t.dropdownList.removeClass(y), t.overlay && t.overlay.children().length && (k.length ? t.menu.insertAfter(k) : t.menu.prependTo(t.parent), t.overlay.attr("style", "").hide()), t.el.triggerHandler("w-close"), t.button.attr("aria-expanded", "false")
            }
        }
        return c
    })
